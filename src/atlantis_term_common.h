// atlantis_term_common.h - Shared terminal code for POSIX and Win32 backends

#ifndef ATLANTIS_TERM_COMMON_H
#define ATLANTIS_TERM_COMMON_H
...
//! @return AtlantisKey value or ATLANTIS_KEY_NONE
    ...
    if (buf[1] == '[') {
        ...
        if (len >= 3 && buf[2] >= '0' && buf[2] <= '9') {
            ...
            if (u_pos) {
                ...
                switch (keycode) {
                case 57352:
                    return shift ? ATLANTIS_KEY_SHIFT_UP : ATLANTIS_KEY_UP;
                case 57353:
                    return shift ? ATLANTIS_KEY_SHIFT_DOWN : ATLANTIS_KEY_DOWN;
                case 57351:
                    if (alt && shift)
