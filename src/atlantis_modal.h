// atlantis_modal.h - Declarative modal form rendering macros

#ifndef ATLANTIS_MODAL_H
#define ATLANTIS_MODAL_H
...
// #region Internal Helpers (implemented in atlantis_modal.c)
