// atlantis_history.h - Session history management

#ifndef ATLANTIS_HISTORY_H
#define ATLANTIS_HISTORY_H
...
//! Load history from .atlantis/.history file
//! Populates app.history and app.hist_count
void hist_load(void);

//! Save history to .atlantis/.history file
void hist_save(void);
