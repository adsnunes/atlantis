...
#ifndef ATLANTIS_THEME_H
#define ATLANTIS_THEME_H
...
typedef AtlantisUnderline UnderlineStyle;
#define UNDERLINE_STYLE_SINGLE ATLANTIS_UNDERLINE_SINGLE
#define UNDERLINE_STYLE_CURLY ATLANTIS_UNDERLINE_CURLY
#define UNDERLINE_STYLE_DOTTED ATLANTIS_UNDERLINE_DOTTED
#define UNDERLINE_STYLE_DASHED ATLANTIS_UNDERLINE_DASHED
