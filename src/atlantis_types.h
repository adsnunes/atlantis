...
#define APP_NAME "atlantis"
#define APP_TAGLINE "Navigate Your Thoughts"
#ifndef VERSION
#define VERSION "dev"
#endif
...
#define HISTORY_DIR_NAME ".atlantis"
...
//! @see atlantis_gap.h for operations
typedef struct {
    char* buffer;
    size_t buffer_size;
    size_t gap_start;
...
typedef struct {
    ...
    Theme theme; //!< AtlantisColor theme
